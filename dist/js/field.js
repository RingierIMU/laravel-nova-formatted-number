...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-formatted-number', __webpack_require__(4));
    Vue.component('detail-formatted-number', __webpack_require__(7));
    Vue.component('form-formatted-number', __webpack_require__(10));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_numeral__ = __webpack_require__(1);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  filters: {
    numberFormat: function numberFormat(number, format) {
      return __WEBPACK_IMPORTED_MODULE_0_numeral___default()(number).format(format);
    }
  }
});
...
var render = function() {
  ...
  return _c("span", [
    _vm._v(_vm._s(_vm._f("numberFormat")(_vm.field.value, _vm.field.format)))
  ])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.formattedField.value = __WEBPACK_IMPORTED_MODULE_0_numeral___default()(this.field.value).format(this.field.format);
  },
  data: function data() {
    return {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_numeral__ = __webpack_require__(1);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fill: function fill(formData) {
      formData.append(this.field.attribute, __WEBPACK_IMPORTED_MODULE_1_numeral___default()(this.formattedNumber).value() || "");
    },
  ...
  computed: {
    formattedNumber: function formattedNumber(number) {
      return __WEBPACK_IMPORTED_MODULE_1_numeral___default()(number.value).format(this.field.format);
    }
  }
});
